...
std::vector<int> build_lcp_array(const std::string& text, const std::vector<int>& suffix_array, const std::vector<int>& inverse_suffix_array) {
    ...
    for (int i = 0; i < n; ++i) {
        ...
        while (i + common_prefix_length < n &&
